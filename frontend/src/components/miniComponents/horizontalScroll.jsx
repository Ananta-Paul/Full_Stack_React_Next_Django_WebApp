  ...
  return (
    <div className="group/hr  mt-2">
      <div className=" relative w-full">
        <h2 className=" absolute top-0 w-full border-gray-300 bg-slate-300 py-4 pl-4 text-2xl font-medium  text-gray-900 dark:bg-gray-900 dark:text-white">
          {heading}
        </h2>
        <div
          id={heading}
          ...
          className=" scrollbar-hide flex gap-3 overflow-x-scroll overscroll-x-none scroll-smooth p-2 pt-16 pb-5  transition-none"
        >
          {children}
        </div>
        {arrows.left && (
