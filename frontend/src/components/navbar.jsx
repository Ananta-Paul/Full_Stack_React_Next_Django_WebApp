...
const Navbar = () => {
  ...
  const { Tokens, user, setTokens } = AuthState();
          ...
          {user ? (
            <div ref={userRef} className="relative">
              ...
              >
                ...
                <FaUser className="text-gray-500 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-900 dark:focus:ring-gray-700 h-8 w-8 rounded-full" />
                {/* <Image
